    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructions', models.CharField(default='This are instructions for a test exam', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optionE', models.CharField(max_length=100, null=True)),
                ('answer', models.CharField(max_length=100)),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_auth.exam')),
            ],
        ),
    ]
